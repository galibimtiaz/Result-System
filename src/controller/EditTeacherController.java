...
public class EditTeacherController {
    ...
    @FXML
    private ComboBox<User> teachers;
    ...
    void editTeacher(ActionEvent event) {
        ...
        if (!Utils.checkTextError(year, msg, "Please enter Year")
                || !Utils.checkTextError(teachers, msg, "Please enter Teacher")
    ...
    private void setProperty() {
        ...
        teachers.getItems().addAll(DatabaseHelper.getInstance().getUsersByType(Constants.TEACHER));

        teachers.setConverter(new StringConverter<User>() {
            @Override
        ...
        dept.setConverter(new StringConverter<Department>() {
            ...
            public String toString(Department object) {
                return object.getName() + " - " + object.getAbout();
            }
    ...
    @FXML
    void teacherChange(ActionEvent event) {
        update();
    }
    ...
    private void update() {
        ...
        user = teachers.getSelectionModel().getSelectedItem();
